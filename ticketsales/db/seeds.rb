...
#Tickets
t1 = Ticket.create(price:2000,category:"Niño",event:e1)
t2 = Ticket.create(price:10000,category:"Adulto",event:e1)
t3 = Ticket.create(price:4000,category:"Estudiante",event:e1)
t4 = Ticket.create(price:3000,category:"Niño",event:e2)
t5 = Ticket.create(price:12000,category:"Adulto",event:e2)
t6 = Ticket.create(price:5000,category:"Estudiante",event:e2)
t7 = Ticket.create(price:1000,category:"Niño",event:e3)
t8 = Ticket.create(price:8000,category:"Adulto",event:e3)
t9 = Ticket.create(price:2000,category:"Estudiante",event:e3)
#Orders
o1 = Order.create(amount:1,user:u1,ticket:t1)
o2 = Order.create(amount:1,user:u1,ticket:t4)
...
o7 = Order.create(amount:1,user:u3,ticket:t3)
...
o11 = Order.create(amount:1,user:u4,ticket:t5)
o12 = Order.create(amount:1,user:u4,ticket:t8)
o13 = Order.create(amount:1,user:u5,ticket:t3)
o14 = Order.create(amount:1,user:u5,ticket:t6)
